...
public class Tc11_Amz_Card_Details extends Amz_Launch_And_Quit//Test_Listing
{

	@Test//(timeOut=200)//ThreadTimeOutException
	public void tc11_Amz_Card_Details_card() throws EncryptedDocumentException, IOException, InterruptedException
	{
...
//		Amz_Delete_Product_In_Cart apc = new Amz_Delete_Product_In_Cart(edriver);
//	    apc.delete_product(edriver);
		//textarea[name=q]
