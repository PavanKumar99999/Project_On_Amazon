...
public class Tc14_Amz_Verify_Review_Order extends Amz_Launch_And_Quit//Test_Listing
{

	@Test//(timeOut=200)//ThreadTimeOutException
	public void tc14_Amz_Verify_Review_Order_card() throws EncryptedDocumentException, IOException, InterruptedException
	{
	   ...
	   Amz_Main_page main = new Amz_Main_page(edriver);
		...
		Amz_Modified_User_Profile mup = new Amz_Modified_User_Profile(edriver);
		mup.your_order(edriver);
		mup.review(edriver);
		mup.rateing();
...
//		acp.net_banking_all();
//		
//		//acp.cash_on_delivery();
//		
//		acp.select_card(edriver);
//		acp.enter_card_number(edriver);
//		
//		//acp.payment();		
//		acp.net_banking_all();
//		
